...
function BookCard({ book, onEdit, onDelete, onRate, onReact, onMove, onSelect }) {
  ...
  return (
    <div
      ...
      className="bg-[#1a0f2e]/70 rounded-xl border-2 border-[#8458B3]/40 hover:border-[#a0d2eb] hover:-translate-y-1 hover:shadow-[0_0_20px_rgba(160,210,235,0.4)] transition-all duration-200 cursor-pointer flex gap-3 p-2 group relative elevation-1 hover:elevation-2 shadow-transition media-card backdrop-blur-xl"
    >
    ...
    <div className={`min-h-screen bg-gradient-to-br from-[#1a1625] to-[#2d1b4e] ${theme} flex flex-col`}>
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div className="flex items-center gap-4">
              ...
              <div className="flex gap-6 nav-container">
                ...
                <span className="text-lg font-semibold text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-emerald-400 to-teal-400 nav-icon">
                  📚 <span>Book</span>
                </span>
                <a
                  href="/comics.html"
        ...
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-4 nav-container">
              ...
              <span className="text-lg font-semibold text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-emerald-400 to-teal-400 nav-icon">📚 <span>Book</span></span>
          ...
          <div className="flex items-center gap-2">
            <button className="p-2 relative hover:bg-gray-800/50 rounded-lg">
              <Icon name="bell" className="w-5 h-5 text-green-400" />
            ...
            <div className="space-y-4">
              ...
              <div className="mt-6">
                <button
                  ...
                  className="w-full flex items-center justify-between p-3 bg-[#10b981]/15 border border-[#a8e6cf]/30 rounded-lg hover:bg-[#10b981]/25 transition-colors mb-2"
                >
                  <div className="flex items-center gap-2">
                ...
                {showPrivacySettings && (
                  <div className="space-y-4 mt-2">
                    {/* Публичный профиль */}
                    <div className="flex items-center justify-between p-3 bg-[#10b981]/10 rounded-lg border border-[#a8e6cf]/20">
                      <div className="flex-1">
                    ...
                    <div className="flex items-center justify-between p-3 bg-[#10b981]/10 rounded-lg border border-[#a8e6cf]/20">
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-gray-400">Другие пользователи могут видеть вашу статистику книг</p>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input 
                          type="checkbox" 
      ...
      {showMobileMenu && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <div className="fixed left-0 top-0 h-full w-80 bg-gray-900/95 backdrop-blur-xl border-r border-green-500/30 shadow-2xl transform transition-transform duration-300 ease-in-out">
            <div className="p-6">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <button 
                    onClick={() => setShowMobileMenu(false)}
                    className="w-full flex items-center gap-3 px-3 py-2 rounded-lg mb-2 bg-green-500/20 text-green-400"
                  >
                    📚 <span>Book</span>
                  </button>
                  <button 
